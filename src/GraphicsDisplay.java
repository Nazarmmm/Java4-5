...
public class GraphicsDisplay extends JPanel {
    ...
    public GraphicsDisplay() {
        ...
        BasicStroke dashed = new BasicStroke(3, BasicStroke.CAP_BUTT,
                ...
                0, new float[]{16, 4, 8, 4, 4, 4, 8, 4, 16}, 0);
    ...
    protected void paintMarkers(Graphics2D canvas) {
        ...
        for (Double[] point: graphicsData) {
            ...
            if (point[0] >= viewport[0][0] && point[1] <= viewport[0][1] && point[0] <= viewport[1][0]) {
                ...
                if(ShowExtremums) {
                    Boolean b = false;
                    if (i_n != 0 && i_n != graphicsData.length - 1) {
                        if (graphicsData[i_n - 1][1] < graphicsData[i_n][1] &&
                                graphicsData[i_n + 1][1] < graphicsData[i_n][1]) {
                    ...
                    if (b) {
                        String string = String.valueOf(graphicsData[i_n][1]);
                        String finalStr = "";
                        int counter = 0;
                        for (int i_m = 0; i_m < string.length(); i_m++) {
                            ...
                            finalStr += string.charAt(i_m);
                        }
                        canvas.setFont(areaFont);
                        canvas.drawString(finalStr, (float) center.x - 10, (float) center.y - 20);
                    }
                }
                ...
                if (i_n == this.selectedMarker) {
                    ...
                    canvas.draw(new Line2D.Double(center.x, center.y - 5.5, center.x - 5.5, center.y));
                    canvas.draw(new Line2D.Double(center.x - 5.5, center.y, center.x, center.y + 5.5));
                    canvas.draw(new Line2D.Double(center.x, center.y + 5.5, center.x + 5.5, center.y));
                    canvas.draw(new Line2D.Double(center.x + 5.5, center.y, center.x, center.y - 5.5));
                }
            }

...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
        ...
        Action showExtremums = new AbstractAction("Show extemum") {
            public void actionPerformed(ActionEvent event) {
                display.setShowExtremums(showExtremumsMenuItem.isSelected());
            }
        };
        showExtremumsMenuItem = new JCheckBoxMenuItem(showExtremums);
        graphicsMenu.add(showExtremumsMenuItem);
        showExtremumsMenuItem.setEnabled(false);
    ...
    private class GraphicsMenuListener implements MenuListener {
        public void menuSelected(MenuEvent e) {
            ...
            showExtremumsMenuItem.setEnabled(fileLoaded);
